...
// Get posts for profile page - similar to dashboard but for specific user
router.get("/:userId/posts", ensureAuthenticated, async (req, res) => {
  try {
    ...
    // Get posts from the profile user
